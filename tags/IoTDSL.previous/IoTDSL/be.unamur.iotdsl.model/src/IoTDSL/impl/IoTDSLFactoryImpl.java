...
public class IoTDSLFactoryImpl extends EFactoryImpl implements IoTDSLFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case IoTDSLPackage.IO_TMODEL: return createIoTModel();
			case IoTDSLPackage.STRING_TYPE: return createStringType();
			case IoTDSLPackage.BOOLEAN_TYPE: return createBooleanType();
			case IoTDSLPackage.VOID_TYPE: return createVoidType();
			case IoTDSLPackage.REAL_TYPE: return createRealType();
			case IoTDSLPackage.INTEGER_TYPE: return createIntegerType();
			case IoTDSLPackage.ENUMERATION: return createEnumeration();
			case IoTDSLPackage.ENUMERATION_LITERAL: return createEnumerationLiteral();
	 ...
	 * @generated
	 */
	public IoTModel createIoTModel() {
		IoTModelImpl ioTModel = new IoTModelImpl();
		return ioTModel;
	}
