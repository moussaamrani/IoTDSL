 ...
 * </p>
 * <ul>
 *   <li>{@link be.unamur.iot.iotdsl.impl.EnumLiteralImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumLiteralImpl extends MinimalEObjectImpl.Container implements EnumLiteral {
	...
	protected EClass eStaticClass() {
		return IotdslPackage.Literals.ENUM_LITERAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IotdslPackage.ENUM_LITERAL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IotdslPackage.ENUM_LITERAL__NAME:
				return getName();
		}
