...
public class IotdslFactoryImpl extends EFactoryImpl implements IotdslFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case IotdslPackage.CONFIGURATION: return createConfiguration();
	 ...
	 * @generated
	 */
	public WithinExpression createWithinExpression() {
		WithinExpressionImpl withinExpression = new WithinExpressionImpl();
	 ...
	 * @generated
	 */
	public AfterExpression createAfterExpression() {
		AfterExpressionImpl afterExpression = new AfterExpressionImpl();
