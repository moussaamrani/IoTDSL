 ...
 * </p>
 * <ul>
 *   <li>{@link be.unamur.iot.iotdsl.impl.DeviceImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceImpl extends NodeImpl implements Device {
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, IotdslPackage.DEVICE__FEATURES);
		}
		return features;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IotdslPackage.DEVICE__FEATURES:
