...
public class IoTDSLCodeExecutor extends CodeExecutorDispatcher 
	...
	public IoTDSLCodeExecutor(){
		...
		addExecutor(new org.gemoc.execution.concurrent.ccsljavaengine.extensions.k3.dsa.impl.MelangeCodeExecutor(this,
			"be.unamur.iotdsl.xdsml.melange.IoTDSL"));
